...
class _Obj {
    ...
    */
    ...
    /**
     * get object by id (#id), like for button
     */
     ...
     * return boolean
     */
    static hasAttr(obj: JQuery, attr: string): boolean {
        return (obj.attr(attr) != null);
    }
    ...
    //rename css class
    static renameCss(obj: JQuery, oldCss: string, newCss: string) {
