...
export default class _Obj {
    ...
    static getId(obj) {
        var _a;
        return (obj.length > 0) ? (_a = obj.attr('id')) !== null && _a !== void 0 ? _a : '' : '';
    }
    /**
     * get name of object
     */
    static getName(obj) {
        var _a;
        return (obj.length > 0) ? (_a = obj.attr('name')) !== null && _a !== void 0 ? _a : '' : '';
    }
    /**
...
//# sourceMappingURL=../../../_tsBase/wwwroot/map/base/_Obj.js.map