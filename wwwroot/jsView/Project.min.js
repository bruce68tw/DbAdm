    ...
    var config = {
      ...
      columnDefs: [
        { targets: [4], render: function(data, type, full, meta) {
          var html = '<button type="button" class="btn btn-link" data-onclick="_me.onImport" data-args="{0}">{1}</button> | <button type="button" class="btn btn-link" data-onclick="_me.onGenWord" data-args="{0}">{2}</button> | <button type="button" class="btn btn-link" data-onclick="_me.onGenLogSql" data-args="{0}">{3}</button>';
