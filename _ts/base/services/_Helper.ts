...
export default class _Helper {
     ...
     * ??
     */
    static getBaseProp(rowNo: number, fid: string, value: string,
        type: string, required: boolean, editable: boolean,
        extAttr:StrN=null): string {
    ...
    static getEventAttr(fnName: string, fnValue: string, args:StrN=null): string {
