...
var _IHtml = /** @class */ (function (_super) {
    ...
    //set edit status
    _IHtml.setEditO = function (obj, status) {
     ...
     */
    _IHtml.init = function (edit, prog, height) {
    ...
    _IHtml.setEdits = function (box, subFilter, status) {
