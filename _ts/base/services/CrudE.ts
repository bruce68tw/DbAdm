...
export default class CrudE {
    ...
    public edit0: EditOne | null = null; // EditOne object
    public eform0: JQueryN = null; // Master edit form
    ...
    constructor(edits: any[]) {
        ...
        if (this.hasEdit) {
            ...
            let edit0: EditOne;  //master edit object
            if (this.edits == null) {
                edit0 = new EditOne();
                //this.hasChild = false;
            } else {
                ...
                if (this.edits.length > 1) {
                    ...
                    for (let i = 1; i < this.edits.length; i++)
                        (edit0 as any)[Childs][i - 1] = this.edits[i];
                }
            }
            ...
            let childs = (edit0 as any)[Childs];
    ...
    public dataSetFileJson(data: FormData, fileJson: any): void {
        ...
        if (data.has(fid)) {
            const json = data.get(fid) as Json;
